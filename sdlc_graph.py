...
def security_review(state: State):
    ...
    template="""
You are a senior cybersecurity expert specializing in secure coding practices.

Your task is to perform a thorough **security review** of the following Python code:
...
Please return your answer in **valid JSON format only**, with the following keys:

```json
{{
  "status": "Approve" or "Denied",
  "review": "Detailed explanation of your review"
}}

⚠️ Do NOT use any other status besides "Approve" or "Denied".
""",
